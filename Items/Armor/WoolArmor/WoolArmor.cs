...
namespace EbonianMod.Items.Armor.WoolArmor
{
    ...
    public class WoolenUshanka : ModItem
    {
        ...
        {
            CreateRecipe().AddIngredient(ItemID.SilverBar, 10).AddIngredient<Wool>(20).AddTile(TileID.Anvils).Register();
            CreateRecipe().AddIngredient(ItemID.TungstenBar, 10).AddIngredient<Wool>(20).AddTile(TileID.Anvils).Register();
        }
    }
    ...
    public class WoolenCoat : ModItem
    {
        ...
        public override void AddRecipes()
        {
            CreateRecipe().AddIngredient(ItemID.SilverBar, 15).AddIngredient<Wool>(30).AddTile(TileID.Anvils).Register();
            CreateRecipe().AddIngredient(ItemID.TungstenBar, 15).AddIngredient<Wool>(30).AddTile(TileID.Anvils).Register();
        }
    }
    ...
    public class WoolenBoots : ModItem
    {
        ...
        public override void AddRecipes()
        {
            CreateRecipe().AddIngredient(ItemID.SilverBar, 10).AddIngredient<Wool>(25).AddTile(TileID.Anvils).Register();
            CreateRecipe().AddIngredient(ItemID.TungstenBar, 10).AddIngredient<Wool>(25).AddTile(TileID.Anvils).Register();
        }
    }
}
