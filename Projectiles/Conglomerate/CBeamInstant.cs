    ...
    public class CBeamInstant : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.timeLeft == 30)
            {
                ...
                Projectile.NewProjectile(null, Projectile.Center + Projectile.velocity * 10, Vector2.Zero, ModContent.ProjectileType<CFlareExplosion>(), 0, 0);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (float i = 0; i < 1; i += 0.001f)
            {
                ...
                Color col = Color.White * 0.75f * s;
                Color col2 = Color.White * 0.75f * s;
                ...
                if (Projectile.ai[1] > 0)
                {
                    ...
                    verticesMain1.Add(Helper.AsVertex(start + off * i + new Vector2(MathHelper.SmoothStep(0, 50, sLin * 2), 0).RotatedBy(rot - MathHelper.PiOver2) * Projectile.ai[1], new Vector2(_off, 0), col2 * Projectile.ai[1] * 2));
                    ...
                    verticesMain2.Add(Helper.AsVertex(start + off * i + new Vector2(MathHelper.SmoothStep(0, 20, sLin * 2), 0).RotatedBy(rot - MathHelper.PiOver2) * Projectile.ai[1], new Vector2(_off, 0), col2 * Projectile.ai[1]));
                }
                if (Projectile.ai[2] > 0)
                {
                    ...
                    verticesFlash.Add(Helper.AsVertex(start + off * 1.2f * i + new Vector2(MathHelper.SmoothStep(20, 85, i * 3), 0).RotatedBy(rot - MathHelper.PiOver2) * Projectile.ai[2], new Vector2(_off, 0), col2 * Projectile.ai[2] * 4));
                }
            }
