...
namespace EbonianMod.Projectiles.Exol
{
    internal class EMine : ModProjectile
    {
        ...
        {if (Projectile.ai[0] == 0)
            {
                Projectile.NewProjectileDirect(Projectile.InheritSource(Projectile), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<Noise>(), 0, 0);
                Projectile.NewProjectileDirect(Projectile.InheritSource(Projectile), Projectile.Center, Vector2.Zero, ModContent.ProjectileType<NoiseOverlay>(), 0, 0);
                Projectile.ai[0] = 1;
